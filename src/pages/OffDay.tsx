...
const OffDay = () => {
    ...
    const { isOpen: isOpenCreateModal, onOpen: onOpenCreateModal, onClose: onCloseCreateModalModal } = useDisclosure();
    const { isOpen: isOpenDeleteModal, onOpen: onOpenDeleteModal, onClose: onCloseDeleteModalModal } = useDisclosure();
  ...
  return (
    ...
    <RoleGuard allowedRoles={["company_admin"]}>
        ...
        <CreateOffDateModal isOpen={isOpenCreateModal} onClose= {onCloseCreateModalModal} />
    ...
    <ConfirmDialogBox
        ...
        onClose={onCloseDeleteModalModal}
    />
